...
void betray_key_codes_init(void)
{
	...
	betray_buttons[BETRAY_ENUM_BUTTON_TAB].system_code = VK_TAB;
	betray_buttons[BETRAY_ENUM_BUTTON_CLEAR].system_code = VK_CLEAR;
	betray_buttons[BETRAY_ENUM_BUTTON_RETURN].system_code = VK_RETURN;
	betray_buttons[BETRAY_ENUM_BUTTON_SHIFT].system_code = VK_SHIFT;
	betray_buttons[BETRAY_ENUM_BUTTON_ALT].system_code = 18;
	betray_buttons[BETRAY_ENUM_BUTTON_CONTROL].system_code = VK_CONTROL;
	betray_buttons[BETRAY_ENUM_BUTTON_MENU].system_code = VK_MENU;
	betray_buttons[BETRAY_ENUM_BUTTON_PAUSE].system_code = VK_PAUSE;
	betray_buttons[BETRAY_ENUM_BUTTON_CAPS_LOCK].system_code = VK_CAPITAL;
	betray_buttons[BETRAY_ENUM_BUTTON_ESCAPE].system_code = VK_ESCAPE;
	betray_buttons[BETRAY_ENUM_BUTTON_SPACE].system_code = VK_SPACE;
	betray_buttons[BETRAY_ENUM_BUTTON_PREV].system_code = VK_PRIOR;
	betray_buttons[BETRAY_ENUM_BUTTON_NEXT].system_code = VK_NEXT;
	betray_buttons[BETRAY_ENUM_BUTTON_END].system_code = VK_END;
	betray_buttons[BETRAY_ENUM_BUTTON_HOME].system_code = VK_HOME;
	betray_buttons[BETRAY_ENUM_BUTTON_LEFT].system_code = VK_LEFT;
	betray_buttons[BETRAY_ENUM_BUTTON_UP].system_code = VK_UP;
	betray_buttons[BETRAY_ENUM_BUTTON_RIGHT].system_code = VK_RIGHT;
	betray_buttons[BETRAY_ENUM_BUTTON_DOWN].system_code = VK_DOWN;
	...
	betray_buttons[BETRAY_ENUM_BUTTON_SCREENSHOT].system_code = VK_SNAPSHOT;
	betray_buttons[BETRAY_ENUM_BUTTON_INSERT].system_code = VK_INSERT;
	betray_buttons[BETRAY_ENUM_BUTTON_DELETE].system_code = VK_DELETE;
	betray_buttons[BETRAY_ENUM_BUTTON_BACKSPACE].system_code = 8;
	betray_buttons[BETRAY_ENUM_BUTTON_HELP].system_code = VK_HELP;
	betray_buttons[BETRAY_ENUM_BUTTON_0].system_code = 0X30;
	betray_buttons[BETRAY_ENUM_BUTTON_1].system_code = 0X31;
	betray_buttons[BETRAY_ENUM_BUTTON_2].system_code = 0X32;
	betray_buttons[BETRAY_ENUM_BUTTON_3].system_code = 0X33;
	betray_buttons[BETRAY_ENUM_BUTTON_4].system_code = 0X34;
	betray_buttons[BETRAY_ENUM_BUTTON_5].system_code = 0X35;
	betray_buttons[BETRAY_ENUM_BUTTON_6].system_code = 0X36;
	betray_buttons[BETRAY_ENUM_BUTTON_7].system_code = 0X37;
	betray_buttons[BETRAY_ENUM_BUTTON_8].system_code = 0X38;
	betray_buttons[BETRAY_ENUM_BUTTON_9].system_code = 0X39;
	betray_buttons[BETRAY_ENUM_BUTTON_A].system_code = 0X41;
	betray_buttons[BETRAY_ENUM_BUTTON_B].system_code = 0X42;
	betray_buttons[BETRAY_ENUM_BUTTON_C].system_code = 0X43;
	betray_buttons[BETRAY_ENUM_BUTTON_D].system_code = 0X44;
	betray_buttons[BETRAY_ENUM_BUTTON_E].system_code = 0X45;
	betray_buttons[BETRAY_ENUM_BUTTON_F].system_code = 0X46;
	betray_buttons[BETRAY_ENUM_BUTTON_G].system_code = 0X47;
	betray_buttons[BETRAY_ENUM_BUTTON_H].system_code = 0X48;
	betray_buttons[BETRAY_ENUM_BUTTON_I].system_code = 0X49;
	betray_buttons[BETRAY_ENUM_BUTTON_J].system_code = 0X4A;
	betray_buttons[BETRAY_ENUM_BUTTON_K].system_code = 0X4B;
	betray_buttons[BETRAY_ENUM_BUTTON_L].system_code = 0X4C;
	betray_buttons[BETRAY_ENUM_BUTTON_M].system_code = 0X4D;
	betray_buttons[BETRAY_ENUM_BUTTON_N].system_code = 0X4E;
	betray_buttons[BETRAY_ENUM_BUTTON_O].system_code = 0X4F;
	betray_buttons[BETRAY_ENUM_BUTTON_P].system_code = 0X50;
	betray_buttons[BETRAY_ENUM_BUTTON_Q].system_code = 0X51;
	betray_buttons[BETRAY_ENUM_BUTTON_R].system_code = 0X52;
	betray_buttons[BETRAY_ENUM_BUTTON_S].system_code = 0X53;
	betray_buttons[BETRAY_ENUM_BUTTON_T].system_code = 0X54;
	betray_buttons[BETRAY_ENUM_BUTTON_U].system_code = 0X55;
	betray_buttons[BETRAY_ENUM_BUTTON_V].system_code = 0X56;
	betray_buttons[BETRAY_ENUM_BUTTON_W].system_code = 0X57;
	betray_buttons[BETRAY_ENUM_BUTTON_X].system_code = 0X58;
	betray_buttons[BETRAY_ENUM_BUTTON_Y].system_code = 0X59;
	betray_buttons[BETRAY_ENUM_BUTTON_Z].system_code = 0X5A;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD0].system_code = VK_NUMPAD0;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD1].system_code = VK_NUMPAD1;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD2].system_code = VK_NUMPAD2;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD3].system_code = VK_NUMPAD3;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD4].system_code = VK_NUMPAD4;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD5].system_code = VK_NUMPAD5;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD6].system_code = VK_NUMPAD6;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD7].system_code = VK_NUMPAD7;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD8].system_code = VK_NUMPAD8;
	betray_buttons[BETRAY_ENUM_BUTTON_NUMPAD9].system_code = VK_NUMPAD9;
	betray_buttons[BETRAY_ENUM_BUTTON_MULTIPLY].system_code = VK_MULTIPLY;
	betray_buttons[BETRAY_ENUM_BUTTON_ADD].system_code = VK_ADD;
	betray_buttons[BETRAY_ENUM_BUTTON_SUBTRACT].system_code = VK_SUBTRACT;
	betray_buttons[BETRAY_ENUM_BUTTON_DIVIDE].system_code = VK_DIVIDE;
	betray_buttons[BETRAY_ENUM_BUTTON_F1].system_code = VK_F1;
	betray_buttons[BETRAY_ENUM_BUTTON_F2].system_code = VK_F2; 
	betray_buttons[BETRAY_ENUM_BUTTON_F3].system_code = VK_F3;
	betray_buttons[BETRAY_ENUM_BUTTON_F4].system_code = VK_F4;
	betray_buttons[BETRAY_ENUM_BUTTON_F5].system_code = VK_F5;
	betray_buttons[BETRAY_ENUM_BUTTON_F6].system_code = VK_F6;
	betray_buttons[BETRAY_ENUM_BUTTON_F7].system_code = VK_F7;
	betray_buttons[BETRAY_ENUM_BUTTON_F8].system_code = VK_F8;
	betray_buttons[BETRAY_ENUM_BUTTON_F9].system_code = VK_F9;
	betray_buttons[BETRAY_ENUM_BUTTON_F10].system_code = VK_F10;
	betray_buttons[BETRAY_ENUM_BUTTON_F11].system_code = VK_F11;
	betray_buttons[BETRAY_ENUM_BUTTON_F12].system_code = VK_F12;
